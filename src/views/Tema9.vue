      ...
      SlyderA(tipo="b")
        .row
          .col-md-6.mb-4.mb-md-0
            h4 Seguridad y salud en el trabajo en granjas avícolas
            p El estado colombiano ha venido trabajando sobre los estándares mínimos que se deben tener en cuenta en una empresa del sector avícola, para proteger la salud y la vida de los empleados, a continuación, se mencionan algunos conceptos.

          .col-md-6
            figure
              img(src='@/assets/curso/temas/tema9/img-48.png', alt='Texto que describa la imagen')
        ...
        .row
          ...
          .col-md-6
            figure
              img(src='@/assets/curso/temas/tema9/img-49.png', alt='Texto que describa la imagen')
        ...
        .row
          ...
          .col-md-6
            figure
              img(src='@/assets/curso/temas/tema9/img-50.png', alt='Texto que describa la imagen')
        ...
        .row
          ...
          .col-md-6
            figure
              img(src='@/assets/curso/temas/tema9/img-52.png', alt='Texto que describa la imagen')
        ...
        .row
          ...
          .col-md-6
            figure
              img(src='@/assets/curso/temas/tema9/img-53.png', alt='Texto que describa la imagen')
