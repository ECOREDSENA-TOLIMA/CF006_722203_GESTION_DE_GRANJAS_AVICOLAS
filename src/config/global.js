export default {
  ...
  menuPrincipal: {
    menu: [
      ...
      },
      {
        nombreRuta: 'tema17',
        numero: '17',
        titulo: 'Sanitización y estabilización de la pollinaza y gallinaza',
        desarrolloContenidos: true,
      },
      {
        nombreRuta: 'tema18',
  ...
  complementario: [
    {
      tema: '11.2 Protocolos de bioseguridad, ejemplo de la Empresa Avicol.',
      referencia:
        'Henao. M. F. (2012). Bioseguridad, acceso a plantas y granjas en Avicol. [Video]. YouTube.',
      tipo: 'Video',
    ...
    {
      tema: '15.4 Ficha técnica',
      referencia: 'Vidapec. Criadora infrarroja de termostato. (s.f).',
      tipo: 'PDF',
      link: 'https://vidapec.com/wp-content/uploads/2018/02/CPIJ0204005.pdf',
    },
    {
      tema: '17.2 Especificaciones técnicas del producto Fumigadora 20L',
      referencia: 'Lahura. Fumigadora 20L. (2019).',
      tipo: 'PDF',
      link:
  ...
  referencias: [
    ...
    {
      referencia:
        'ICA. (2020). Grupo de Inocuidad en la Producción Pecuaria Primaria y Bienestar Animal. En [Sitio Web]. ',
      link:
    ...
    {
      referencia:
        'Resolución 090464. (2021). [Instituto Colombiano Agropecuario]. «Por medio de la cual se establece el Registro Sanitario de Predio Pecuario-RSPP». Enero 20 de 2021. 1-15. ',
      link:
    ...
    {
      referencia:
        'Valencia, C. A. M., & Rodríguez, M. L. B. (2010). Manual de Gestión Integral de Residuos. 1, 105. ',
      link:
        'http://www.ins.gov.co/BibliotecaDigital/manual-gestion-integral-residuos.pdf',
    },
  ],
  creditos: [
    {
